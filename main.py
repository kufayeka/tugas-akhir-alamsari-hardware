...
if __name__ == '__main__':
    ...
    p2 = multiprocessing.Process(target=process2, args=(gv.hum1, gv.PID_kp, gv.PID_ki, gv.PID_kd, gv.PID_pv, gv.PID_output, gv.PID_set_point, gv.PWM_enabled, gv.PWM_high_time, gv.PWM_low_time))
